...
del Z:\Builds\LocalNotion\osx-arm64\*.pdb
del Z:\Builds\LocalNotion\osx-arm64\*.dll
...
del Z:\Builds\LocalNotion\linux-arm\*.pdb
del Z:\Builds\LocalNotion\linux-arm\*.dll
